...
class SoftmaxGenerativeClassifier:
    ...
    def recover_parameters(self):
        ...
        # this is wrong conceptually btw but lets ignore
...
class ImportanceSamplingClassifier:
    ...
    def score(self, X):
        ...
        Returns:
            np.ndarray: shape (B, K)
        """
        # TODO ignore if you want it can br a helper if u wish to use it
        return None
    ...
    def estimate_normalizer(self, X):
        ...
        # compute scores on said y_m, how will the num_samples factor come into play in the shape here?!
    ...
    def gradients(self, X, y):
        ...
        np.add.at(error, (slice(None), self.y_m), P_sampled) # ! think about what this does
    ...
    def fit(self, X, y):
        ...
        # for mini batch SGD, compute a permutation over [0..N-1]; run over it in increments of BATCH_SIZE
        # once you do one full pass (called 1 epoch) start fresh and reshuffle array!
        # this can be more efficient than random (wo replacement) sampling!
        
        idx = np.arange(N) # permutation of [0,..,n-1]
...
class NCEClassifier:
    ...
    def gradients(self, X, y):
        ...
        # Compute score on real data
        f_th = self.score(X, y)  # B
        
        # Generate noisea nd its score
        ...
        # ! TODO compute these logits using above
        # ! ensure numerical stability with taking log
        z_real = None
        z_noise = None
        ...
        # concatenating for easy gradient calculations!
        ...
        # ! TODO: accumulate gradients on g_w and g_b based on weights
        #...
        #...
